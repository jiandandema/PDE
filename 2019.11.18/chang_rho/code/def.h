...
typedef struct {
  ...
  PetscScalar    eu[9], ev[9], W, rate, Re;
  PetscScalar    w[9];
  PetscInt       c, nits;
  ...
  Vec            x, px, func, tao, F;                              /* current and previous solution  */
  PetscInt       Nx, Q, Ny;
...
extern PetscErrorCode evolution(DMDALocalInfo*, Vec, Vec, Vec, AppCtx*);
...
extern PetscErrorCode DataSaveASCIITaoandF(DMDALocalInfo*, Vec, char*, char*);
extern PetscErrorCode Getanalysis(DMDALocalInfo*, AppCtx*);
extern PetscErrorCode ComputeLfunction(DMDALocalInfo*, Field**, Field**, Field**, Field**, AppCtx*);
